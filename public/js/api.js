...
if (typeof API === 'undefined') {
    ...
    async checkComfyUI() {
        try {
            ...
            const response = await fetch(`http://${Config.COMFYUI_HOST}:${Config.COMFYUI_PORT}/`, {
                method: 'HEAD',
                mode: 'cors',
            ...
            Utils.updateStatus("⚠️ ComfyUI not reachable, but you can still generate", "warning");
            return false;
        }
    },
    ...
    async getSystemStats() {
        try {
            const response = await fetch(`http://${Config.COMFYUI_HOST}:${Config.COMFYUI_PORT}/system_stats`);
